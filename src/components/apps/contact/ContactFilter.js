    ...
    <>
      ...
      <ListGroup flush>
        ...
        <ListGroupItem
          ...
          tag="a"
          className={
            active === "show_all" ? "bg-light py-3 border-0" : "py-3 border-0"
          }
        ...
        <ListGroupItem
          ...
          tag="a"
          className={
            active === "frequent_contact"
              ? "bg-light py-3 border-0"
              : "py-3 border-0"
          }
        ...
        <ListGroupItem
          ...
          tag="a"
          className={
            active === "engineering_department"
              ? "bg-light py-3 border-0"
              : "py-3 border-0"
          }
          onClick={() =>
            dispatch(setVisibilityFilter("engineering_department"))
          }
        >
