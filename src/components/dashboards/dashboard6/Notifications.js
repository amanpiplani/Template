...
const Notifications = () => {
  return (
    <DashCard title="Notifications" subtitle="24 new comments">
      <SimpleBar style={{ height: '310px' }}>
        <ListGroup className="bordered-list rounded-0 ">
          {commentsData.map((icomment) => (
            ...
            >
              <div>
                <Image src={icomment.image} alt="user" width="50" height="50" className="rounded-circle" />
              </div>
