                ...
                <div className="p-4">
                  <div className="steamline position-relative border-start ms-4 mt-0">
                    <div className="sl-item my-3 pb-3 border-bottom">
                      <div className="sl-left float-start text-center rounded-circle text-white me-3">
                        <Image
                          src={img2}
                          width="40"
                          height="40"
                      ...
                      <div className="sl-right ps-4">
                        <div>
                          <Link href="/" passhref>
                            <a className="text-dark fs-5">John Doe</a>
                          </Link>
                          <span className="ms-2 text-muted">5 minutes ago</span>
                          <p className="text-muted">
                            assign a new task
                            <Link href="/"> Design weblayout</Link>
                          </p>
                          <Row className="ms-1">
                          ...
                          <div className="desc ms-3">
                            ...
                            >
                              <a className="text-dark">2 comments</a>
                            </Link>
                            <Link
                              href="/"
                              passhref
