    ...
    <Card>
      ...
      <CardBody className="bg-light pt-0">
        <div className="d-flex align-items-center py-3">
          <Image src={user1} className="rounded-circle" width="50" height="50" alt="user" />
          <div className="ms-3">
        ...
        {/* 2 */}
        <div className="d-flex align-items-center py-3">
          <Image src={user2} className="rounded-circle" width="50" height="50" alt="user" />
          <div className="ms-3">
        ...
        {/* 4 */}
        <div className="d-flex align-items-center py-3">
          <Image src={user4} className="rounded-circle" width="50" height="50" alt="user" />
          <div className="ms-3">
